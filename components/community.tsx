...
import { Target, Eye, Building2, CheckCircle, Settings, Zap, Box, Sparkle } from "lucide-react"
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <motion.div
          ...
          style={{
            opacity: useTransform(scrollYProgress, [0, 0.3, 0.7, 1], [0.95, 1, 1, 0.8])
          }}
        />
          ...
          <svg width="100%" height="100%" className="absolute inset-0">
            <defs>
              <pattern id="doodlePattern" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
                ...
                <path d="M160,140 L170,120 L165,120 L175,100 L165,120 L170,120 L160,140 Z" fill="#6FB4C3" opacity="0.9" />
              ...
              style={{
                ...
                boxShadow: useTransform(
                  ...
                  [
                    ...
                    "0 25px 50px -12px rgba(31, 38, 135, 0.5)",
                    "0 25px 50px -12px rgba(31, 38, 135, 0.5)",
                    "0 8px 32px 0 rgba(31, 38, 135, 0.37)"
                  ]
                )
